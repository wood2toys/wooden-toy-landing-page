export default function InsideTheBox() {
  const items = ["হাঁড়ি", "পাতিল", "বাটি", "প্লেট", "গ্লাস", "চামচ", "ডিম", "আপেল", "রান্নার সরঞ্জাম", "ঢেঁকি"];
  return (
    <section className="px-4 py-8 sm:py-12 md:py-16 bg-[#FDFBF7]">
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-6 sm:mb-8 text-[#2D2424] tracking-tight text-center">Inside The Box</h2>
